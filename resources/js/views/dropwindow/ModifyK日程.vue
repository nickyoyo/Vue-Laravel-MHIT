<template>
  ...
  ></textarea
  ><br /><br />
   <input type="radio" name="state" value=0 v-model="state" :checked="state==0"/>談圖取消
   &nbsp;&nbsp;&nbsp;
	<input type="radio" name="state" value=1 v-model="state" :checked="state==1"/>談圖完成
   <br /><br />
  預計成交日 : &nbsp;&nbsp;
  <input
    type="date"
